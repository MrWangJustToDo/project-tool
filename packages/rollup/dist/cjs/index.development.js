...
const getTsLibPath = () => {
    ...
    try {
        ...
        return resolveId(process.env.__TSLIB_TEST_PATH__ || 'tslib/tslib.es6.js', {
            ...
            basedir: url.fileURLToPath(new URL('.', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('cjs/index.development.js', document.baseURI).href))))
        });
    }
    catch (_) {
        return null;
