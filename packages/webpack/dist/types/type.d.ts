...
export type SafeDefineUniversalWebpackConfigProps = Omit<SafeGenerateActionProps, "env" | "entry"> & Pick<DefineUniversalWebpackConfigProps, "serverEntry" | "clientEntry" | "webpackServer" | "webpackClient">;
export {};
