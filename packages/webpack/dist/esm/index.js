...
import { sources, Compilation, DefinePlugin, HotModuleReplacementPlugin } from 'webpack';
...
var devServerConfig = function (_a) {
    ...
    return ({
        ...
        devMiddleware: {
            publicPath: publicPath,
            writeToDisk: function (fileName) { return fileName.includes(MANIFEST.manifest_deps) || fileName.includes(MANIFEST.manifest_dev); },
        },
    });
};
...
var WebpackPageDepsPlugin = /** @class */ (function () {
    ...
    WebpackPageDepsPlugin.prototype.apply = function (compiler) {
        ...
        compiler.hooks.thisCompilation.tap(pluginName, function (compilation) {
            compilation.hooks.processAssets.tapPromise({ name: pluginName, stage: Compilation.PROCESS_ASSETS_STAGE_REPORT }, function () { return _this.emitStates(compilation); });
        });
    };
...
var singleConfig = function (props) {
    var _a;
    return merge(props.env === 'client' ? ClientConfig(props) : ServerConfig(props), (_a = props.extendConfig) === null || _a === void 0 ? void 0 : _a.call(props, props));
};

var definedUniversalWebpackConfig = config;
var definedWebpackConfig = singleConfig;

export { MANIFEST, definedUniversalWebpackConfig, definedWebpackConfig };
