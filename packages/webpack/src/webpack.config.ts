...
export const config = ({
  ...
  ESLINT_CHECK,
  BUNDLE_CHECK,
}: SafeDefineUniversalWebpackConfigProps): Partial<Configuration>[] => {
...
export const singleConfig = (props: SafeGenerateActionProps & { extendConfig?: (props: SafeGenerateActionProps) => Partial<Configuration> }) => {
