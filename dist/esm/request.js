            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = function () { return fetch(props[0], __assign(__assign({}, props[1]), { signal: abort.signal })); };
                        setTimeout(function () { return abort.abort("[fetch] ".concat(timeout, " ms timeout to fetch")); }, timeout);
            ...
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        ...
                        if (__DEV__) {
                            console.error("[axios] fetch adapter create error, ".concat(err.message));
                        }
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (e_1 instanceof FetchTimeOutError) {
                        return [2 /*return*/, new AxiosError(e_1.message, AxiosError["ETIMEDOUT"], config, request)];
                    }
                    return [2 /*return*/, new AxiosError(e_1 === null || e_1 === void 0 ? void 0 : e_1.message, AxiosError["ERR_NETWORK"], config, request)];
                case 4:
                ...
                case 15:
                    e_2 = _b.sent();
                    return [2 /*return*/, new AxiosError(e_2.message, AxiosError["ERR_BAD_RESPONSE"], config, request, response)];
                case 16:
                    response.data = data;
...
export { FetchTimeOutError, createRequest, generateFetchWithTimeout };
